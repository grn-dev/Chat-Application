...
namespace Chat.Infra.Data.Migrations
{
    ...
    [Migration("20220325165432_changeDirectUser")]
    partial class changeDirectUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chat.Domain.Models.DirectUser", b =>
                {
                    b.HasOne("Chat.Domain.Models.User", "DestinationUser")
                        .WithMany("DirectDestinationUsers")
                        .HasForeignKey("DestinationUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Chat.Domain.Models.Direct", null)
                        .WithMany("DirectUsers")
                        .HasForeignKey("DirectId");

                    b.HasOne("Chat.Domain.Models.User", "SourceUser")
