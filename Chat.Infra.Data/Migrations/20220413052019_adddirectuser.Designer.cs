...
namespace Chat.Infra.Data.Migrations
{
    ...
    [Migration("20220413052019_adddirectuser")]
    partial class adddirectuser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chat.Domain.Models.Direct", b =>
                {
                    b.HasOne("Chat.Domain.Models.Message", null)
                        .WithMany("Directs")
                        .HasForeignKey("MessageId");

                    b.HasOne("Chat.Domain.Models.User.User", null)
            ...
            modelBuilder.Entity("Chat.Domain.Models.DirectUser", b =>
                {
                    b.HasOne("Chat.Domain.Models.User.User", "DestinationUser")
                        .WithMany("DirectDestinationUsers")
                    ...
                    b.HasOne("Chat.Domain.Models.User.User", "SourceUser")
                        .WithMany("DirectSourceUsers")
            ...
            modelBuilder.Entity("Chat.Domain.Models.User.User", b =>
                {
                    ...
                    b.Navigation("DirectDestinationUsers");

                    b.Navigation("DirectRecipients");

                    b.Navigation("DirectSenders");

                    b.Navigation("DirectSourceUsers");
