...
namespace EventBusRabbitMQ
{
    ...
    {
        const string BROKER_NAME = "bazargah_event_bus";

        const string AUTOFAC_SCOPE_NAME = "bazargah_event_bus";
            ...
            ILifetimeScope autofac, IEventBusSubscriptionsManager subsManager, string queueName = null, int retryCount = 5)
        {
            ...
            _retryQueueName = "retry." + queueName;
            _retryExchange = "retry." + queueName + ".exchange";
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs eventArgs)
        {
            ...
            {
                _consumerChannel.BasicNack(eventArgs.DeliveryTag, multiple: false, false);
        ...
        private IModel CreateConsumerChannel()
        {
            ...
            channel.ExchangeDeclare(_retryExchange, "fanout");
            channel.QueueDeclare
            (
                _retryQueueName, true, false, false,
